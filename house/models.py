...
class Property(models.Model):
	...
	def __str__(self):
		return f"{self.name} | {self.owner} | {self.amount} | {self.image} | {self.description}"
...
class Tenant(models.Model):
	...
	def __str__(self):
		return f"{self.user.username} | {self.prop.name} | {self.prop.amount} | {self.prop.image} | {self.prop.description}" 
